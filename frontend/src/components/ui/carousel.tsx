...
function CarouselPrevious({
	...
	return (
		<Button
			...
			className={cn(
				"absolute size-8 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 hover:text-gray-800 transition-colors",
				orientation === "horizontal"
...
const DotButtonVariants = cva(
	"size-2 lg:size-3 rounded-full transition-all duration-300",
	{
		variants: {
			selected: {
...
const DotButton = ({
	...
	<button
		type="button"
		className={cn(DotButtonVariants({ selected }))}
		onClick={onClick}
	/>
);
