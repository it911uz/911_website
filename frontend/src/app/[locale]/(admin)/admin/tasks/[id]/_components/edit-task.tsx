        ...
        startTransition(async () => {
            const response = await editTask({
                body: {
                    ...
                    tag_ids: values.tags as number[],
                    user_ids: values.users as number[]
                },
            ...
            toast.success("Таск редактирован");
            router.refresh();
            reset();
            onOpenChange(false);
        })
    ...
    return <Sheet open={open} onOpenChange={onOpenChange}>
        ...
        <SheetContent className="w-3/5">
            ...
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
                ...
                <Button loading={pending} type="submit" size={"lg"} variant={"black"}>Редактировать</Button>
            </form>
        </SheetContent>
    </Sheet>
};
